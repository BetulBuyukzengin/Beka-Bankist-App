...
function OurServices() {
  return (
    <StyledServices id="ourServices">
      ...
      <StyledGridContainer>
        <GridItem
          icon={<StyledImg src="../../../img/wallet.png" alt="money" />}
          button="Learn More"
        ...
        <GridItem
          icon={
            <StyledImg src="../../../img/debit-card.png" alt="credit card" />
          }
          button="Learn More"
